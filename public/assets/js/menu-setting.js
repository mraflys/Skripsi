            ...
            '<div class="style-block">' +
                ...
                '<div class="m-style-scroller">' +
                    ...
                    '<div class="theme-color header-color small">' +
                        '<a href="javascript:void(0);" class="active" data-value="header-default"></a>' +
                        '<a href="javascript:void(0);" class="" data-value="header-blue"></a>' +
                        '<a href="javascript:void(0);" class="" data-value="header-red"></a>' +
                        '<a href="javascript:void(0);" class="" data-value="header-purple"></a>' +
                        '<a href="javascript:void(0);" class="" data-value="header-info"></a>' +
                        '<a href="javascript:void(0);" class="" data-value="header-dark"></a>' +
                    '</div>' +
                    '<hr class="">' +
